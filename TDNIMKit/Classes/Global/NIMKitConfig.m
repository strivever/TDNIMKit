...
- (void)applyDefaultSettings
{
    ...
    _nickFont  = [UIFont systemFontOfSize:15.0];
    ...
    _cellBackgroundColor = NIMKit_UIColorFromRGB(0xf4f4f4);
...
- (NIMKitSetting *)setting:(NIMMessage *)message
{
    ...
    NIMKitSettings *settings = isOutgoingMsg ? self.rightBubbleSettings : self.leftBubbleSettings;
...
- (void)applyDefaultTextSettings
{
    ...
    _textSetting.textColor = _isRight? NIMKit_UIColorFromRGB(0x333333) : NIMKit_UIColorFromRGB(0x333333);
...
- (void)applyDefaultAudioSettings
{
    ...
    _audioSetting.textColor = _isRight? NIMKit_UIColorFromRGB(0x333333) : NIMKit_UIColorFromRGB(0x333333);
