...
- (void)setupTableView
{
    ...
    self.tableView.backgroundColor = NIMKit_UIColorFromRGB(0xf4f4f4);
...
{
    [self.interactor mediaPicturePressedWithVC:self];
}

- (void)onTapMediaItemShoot:(NIMMediaItem *)item
{
    [self.interactor mediaShootPressedWithVC:self];
}
